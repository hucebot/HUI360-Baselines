...
COLORS_SEQUENCE = ["red", "green", "blue", "yellow", "purple", 
                   "orange", "pink", "brown", "gray", "black", 
                   "white"]
COLORS_SEQUENCE_BGR = [(0, 0, 255), (0, 255, 0), (255, 0, 0), (0, 255, 255), (128, 0, 128), 
                       (0, 165, 255), (180, 105, 255), (19, 69, 139), (169, 169, 169), (0, 0, 0), 
                       (255, 255, 255)]

# VitPose keypoint names and connections (17 keypoints)
...
# Same but different name
COCO_17_SKELETON_NAMES = [
    "nose",
    "left_eye",
    "right_eye",
    "left_ear",
...
COCO_17_SKELETON_CONNECTIONS = [
    [15, 13], [13, 11], [16, 14], [14, 12], [11, 12], 
    [5, 11], [6, 12], [5, 6], [5, 7], [6, 8], [7, 9], 
    [8, 10], [1, 2], [0, 1], [0, 2], [1, 3], [2, 4], [3, 5], [4, 6]
]

COCO_17_SKELETON_COLORS = [
    (0, 0, 255),      # nose - red
    (0, 85, 255),     # left_eye - orange
    (0, 170, 255),    # right_eye - yellow-orange
    (0, 255, 255),    # left_ear - yellow
    (0, 255, 170),    # right_ear - yellow-green
    (0, 255, 85),     # left_shoulder - green
    (0, 255, 0),      # right_shoulder - bright green
    (85, 255, 0),     # left_elbow - green-cyan
    (170, 255, 0),    # right_elbow - cyan-green
    (255, 255, 0),    # left_wrist - cyan
    (255, 170, 0),    # right_wrist - cyan-blue
    (255, 85, 0),     # left_hip - blue
    (255, 0, 0),      # right_hip - bright blue
    (255, 0, 85),     # left_knee - blue-purple
    (255, 0, 170),    # right_knee - purple
    (255, 0, 255),    # left_ankle - magenta
    (170, 0, 255),    # right_ankle - pink
]


# 18 kpt format
COCO18_SKELETON_NAMES = ['Nose', 'Neck', 'R-Sho', 'R-Elb', 'R-Wr', 'L-Sho', 'L-Elb', 'L-Wr', 'R-Hip', 'R-Knee', 'R-Ank', 'L-Hip', 'L-Knee', 'L-Ank', 'R-Eye', 'L-Eye', 'R-Ear', 'L-Ear']

COCO18_SKELETON_CONNECTIONS = [[1,2], [1,5], [2,3], [3,4], [5,6], [6,7],
              [1,8], [8,9], [9,10], [1,11], [11,12], [12,13],
              [1,0], [0,14], [14,16], [0,15], [15,17] ]

COCO18_SKELETON_COLORS = [ [0,100,255], [0,100,255], [0,255,255], [0,100,255], [0,255,255], [0,100,255],
         [0,255,0], [255,200,100], [255,0,255], [0,255,0], [255,200,100], [255,0,255],
         [0,0,255], [255,0,0], [200,200,0], [255,0,0]]



# Colors for different keypoint types (BGR format for OpenCV)
VITPOSE_COLORS = [
    (0, 0, 255),      # nose - red
    (0, 85, 255),     # left_eye - orange
    "rosbag2_2025_07_29-13_17_18",
    "rosbag2_2025_07_29-14_09_46",
    "rosbag2_2025_10_07-15_03_48",
    "rosbag2_2025_10_07-16_00_15",
    "rosbag2_2025_10_07-16_21_39",
    "rosbag2_2025_10_08-08_41_21",
    "rosbag2_2025_10_08-09_29_29",
    "rosbag2_2025_10_08-10_32_34",
    "rosbag2_2025_10_08-11_10_26",
    "rosbag2_2025_10_09-08_52_20",
    "rosbag2_2025_10_09-09_10_49",
    "rosbag2_2025_10_09-10_23_38",
    "rosbag2_2025_10_09-17_37_23",
    "rosbag2_2025_10_09-18_50_21",
    "rosbag2_2025_10_14-08_17_10",
    "rosbag2_2025_10_14-09_00_06",
    "rosbag2_2025_10_15-09_37_49",
    "rosbag2_2025_10_15-11_03_05",
    "rosbag2_2025_10_15-12_02_00",
    "rosbag2_2025_10_15-12_27_14",
    "rosbag2_2025_10_15-13_11_27",
    "rosbag2_2025_10_15-14_02_29",
    "rosbag2_2025_10_15-14_30_03",
    "rosbag2_2025_10_16-09_27_48",
    "rosbag2_2025_10_16-11_29_56",
    "rosbag2_2025_10_16-12_47_57",
    "rosbag2_2025_10_17-13_19_29",
    "rosbag2_2025_10_17-14_28_15",
    "rosbag2_2025_10_17-15_11_00",
    "rosbag2_2025_10_17-16_47_09",
    "rosbag2_2025_10_20-10_13_32",
    "rosbag2_2025_10_20-11_51_02",
    "rosbag2_2025_10_20-16_02_46",
    "2022_09_21_astor_place_landfill",
    "2022_09_21_astor_place_recycle",
    "2022_09_26_astor_place_landfill",
    "2022_09_26_astor_place_recycle",
    "2022_09_28_astor_place_landfill",
    "2022_09_28_astor_place_recycle",
    "2022_10_06_astor_place_landfill",
    "2022_10_06_astor_place_recycle",
    "2022_10_12_astor_place_landfill_0",
    "2022_10_12_astor_place_landfill_1",
    "2022_10_12_astor_place_recycle_0",
    "2022_10_12_astor_place_recycle_1",
    "2023_07_06_albee_square_landfill_0",
    "2023_07_06_albee_square_landfill_1",
    "2023_07_06_albee_square_recycle_0",
    "2023_07_06_albee_square_recycle_1",
    "2023_07_07_albee_square_landfill_0",
    "2023_07_07_albee_square_landfill_1",
    "2023_07_07_albee_square_recycle_0",
    "2023_07_07_albee_square_recycle_1",
    "2023_07_11_albee_square_landfill_1",
    "2023_07_11_albee_square_recycle_0",
    "2023_07_11_albee_square_recycle_1",
    "2023_07_12_albee_square_landfill_0",
    "2023_07_12_albee_square_recycle_0",
    "2023_07_12_albee_square_recycle_1",
    "2023_07_14_albee_square_landfill",
    "2023_07_14_albee_square_recycle",
]